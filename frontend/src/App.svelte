...
{:else}
  <div class="page-content {commentPanelOpen ? 'blurred' : ''}">
    <main class="container">
      ...
      <section
        id={article.section_name?.toLowerCase().replace(/\s+/g, '') || `section-${i}`}
        class="column {i % 3 === 1 ? 'midColumn' : 'sideColumn'}"
      >
    ...
    <footer>
      &copy;2025 ECS 162 HW1. &copy;Team 13. All rights reserved.
    </footer>
  </div>
  {/if}
